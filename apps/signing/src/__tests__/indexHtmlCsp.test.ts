...
describe('signing index.html security meta tags', () => {
  ...
  it('keeps the noindex meta directive for the public signing app', () => {
    expect(readHtml()).toMatch(/name="robots"\s+content="noindex,\s*nofollow"/);
  });
